...
@section('vendor')
    ...
    <div class="page-content">
        ...
        {{ $products->short_descp }}
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="editor" name="long_descp">
    ...
    <div class="page-content">
        <h5 class="mb-4 card-title">Update Main Image Thambnail </h5>
        <div class="card">
    ...
    <div class="page-content">
        <h5 class="mb-4 card-title">Update Multi Image </h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('vendor.product.multiimg.delete', $img->id) }}"
                                            class="btn btn-danger text-white" id="delete"> Delete </a>
                                    </td>
                                </tr>
                            @endforeach
                        </form>
